...
broken). If your "Comando externo" field still points at either one,
...
The "Fator de proximidade" (proximity factor) slider (0-100) controls how
closely the result should resemble the original sprite, versus prioritizing
what was asked in the prompt. There's no "strength"/"denoise"-style
